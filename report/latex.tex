...
\begin{itemize}
    \item Two users are authenticated
    \item Actual password is not stored
    \item The passwords are hashed using SHA256 algorithm and stored
...
\begin{itemize}
    ...
    \item Intergrating all the code into classes after making them work. I was just writing self. for half the day
